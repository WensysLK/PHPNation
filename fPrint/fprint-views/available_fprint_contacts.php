<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlmedical = "SELECT contract_details.contractId, contract_details.ContractStartus, 
                   ...
                   WHERE contract_details.ContractStartus = 'started' AND contract_details.hasFingerprint=1
                     AND contract_details.softdeletestatus = 1 AND contract_details.fprintStatus='not_started'";
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <a href="#modal6" class="btn btn-primary btn-sm lni" 
   data-applicant-id="<?php echo $applicantID; ?>" data-applicant-title="<?php echo $applicationTitle; ?>" data-image="<?php echo $applicationPhoto; ?>"
   data-applicant-fname="<?php echo $applicationFname; ?>" data-applicant-lname="<?php echo $applicationLname; ?>"
   data-passport-number ="<?php echo $applicationPassport; ?>" data-contract-id="<?php echo $contractId; ?>" data-dob="<?php echo $applicantDob; ?>" data-nic="<?php echo $applicationNic; ?>"
   data-bs-toggle="modal" data-animation="effect-slide-in-bottom">
    ...
    <?php 
            ...
            echo "<div class='alert alert-primary mt-2' role='alert'> No Available Contracts for Finger Print!</div>";
        }
    } ?>
</table>
