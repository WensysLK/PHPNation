...
ON fprint_details.clientId = contract_details.applicationID WHERE fprint_details.fprintStatus='processing' AND fprint_details.softdeletestatus=1";
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="#modal6" class="btn btn-primary btn-sm lni" data-applicant-id="<?php echo $contractId; ?>"
                    data-applicant-title="<?php echo $applicationTitle; ?>" data-image="<?php echo $imgSrc; ?>"
    ...
    <?php 
            ...
            echo "<div class='alert alert-primary mt-2' role='alert'> No Processing Finger Prints!</div>";
        }
    } ?>
</table>
