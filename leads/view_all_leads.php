...
<body>
    ...
    <div class="content content-fixed bd-b">
            ...
            <div class="card-body pd-y-30">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="available-contracts" role="tabpanel"
                      ...
                      <?php include('leads-parts/total-leads.php'); ?>

                    </div>
                    <div class="tab-pane fade" id="pending" role="tabpanel" aria-labelledby="pending-tab">

                    
                    <?php include('leads-parts/follow-up-leads.php'); ?>
                    </div>
                    <div class="tab-pane fade" id="processing" role="tabpanel" aria-labelledby="processing-tab">

                    <?php include('leads-parts/registered-leads.php'); ?>
                    </div>
        ...
        <?php include('../includes/footer.php'); 
         include('popups/add-lead-popup.php');
