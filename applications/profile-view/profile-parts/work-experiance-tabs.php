...
if (isset($_GET['client_id'])) {
    ...
    if ($result2->num_rows > 0) {
        ...
        //echo '<th>Action</th>'; // Action column for view, edit, delete
        echo '</tr>';
        echo '</thead>';
        echo '<tbody>';
        ...
        while ($row = $result2->fetch_assoc()) {
            ...
            // Action buttons
            /*echo '<td>';
            echo '<a href="view_work.php?id=' . $row['workId'] . '" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a> '; // View icon
            echo '<a href="edit_work.php?id=' . $row['workId'] . '" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a> '; // Edit icon
            echo '<a href="delete_work.php?id=' . $row['workId'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this work experience?\')"><i class="fas fa-trash-alt"></i></a>'; // Delete icon
            echo '</td>';*/
            echo '</tr>';
