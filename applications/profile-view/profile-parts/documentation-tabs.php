...
if (isset($_GET['client_id'])) {
    ...
    if ($result4->num_rows > 0) {
        ...
        //echo '<th>Action</th>'; // Action buttons for View, Download, and Delete
        echo '</tr>';
        echo '</thead>';
        echo '<tbody>';
        ...
        while ($row = $result4->fetch_assoc()) {
            ...
            echo '<a href="download_attachment.php?id=' . $row['attachemnetId'] . '" class="btn btn-success btn-sm">Download</a> '; // Download button
