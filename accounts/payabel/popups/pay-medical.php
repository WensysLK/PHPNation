...
<div class="modal fade" id="medicalpayment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
        ...
        <div class="modal-content tx-14">
            ...
            <div class="modal-body">
                <form action="functions/add-medical-payment.php" method="POST"
                    ...
                    <input type="hidden" name="medicalId" value="" id="medicalId">
                    <div class="row">
                        <div class="col-4">
