...
<body>
    ...
    <div class="content content-fixed bd-b">
                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mg-b-5">
                            ...
                            <li class="breadcrumb-item"><a href="#">Payables</a></li>
                        </ol>
                    </nav>
            ...
            <div class="card-body pd-y-30">
                ...
                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="available-contracts-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="available-contracts" aria-selected="true">Medical Payments</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending"
                            type="button" role="tab" aria-controls="pending"
                            aria-selected="false">Enjaz Payments</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="processing-tab" data-bs-toggle="tab" data-bs-target="#processing"
                            ...
                            aria-selected="false">Muzaned Payment</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="completed-tab" data-bs-toggle="tab" data-bs-target="#completed"
                            type="button" role="tab" aria-controls="completed" aria-selected="false">Beauro Payment</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="deported-tab" data-bs-toggle="tab" data-bs-target="#deported"
                            type="button" role="tab" aria-controls="deported" aria-selected="false">Finger Print</button>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="available-contracts" role="tabpanel"
                      ...
                      <?php include('paymenty-pendings/medical_payment_pending.php'); ?>

                    </div>
                    <div class="tab-pane fade" id="pending" role="tabpanel" aria-labelledby="pending-tab">

                    
                    <?php include('paymenty-pendings/enjaz_payment_pending.php'); ?>
        ...
        <?php include('../payabel/popups/pay-medical.php'); ?>
        <!-- Ajax -->
         <?php 
