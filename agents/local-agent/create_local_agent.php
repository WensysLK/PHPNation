...
<body>
    ...
    <div class="content content-fixed bd-b">
        <div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
            ...
            <div class="content">
                <form method="POST" action="form-parts-insert/local_agent_data_insert.php"
                        ...
                        <div class="col-9">
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    ...
                                    <input type="text" name="nicNumber" class="form-control" id="iqamaNumber">
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="phoneNumber" class="form-control" id="ownerWhatzapp">
                                </div>
                                <div class="col">
