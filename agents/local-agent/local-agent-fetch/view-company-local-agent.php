...
INNER JOIN 
    local_agent_details 
ON 
    fagent_company_details.fagentID = local_agent_details.localagentId 
WHERE 
    fagent_company_details.softdeletestatus = 1 
    AND local_agent_details.localAgentType = 'company'
    ";
