<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    <?php
        ...
        INNER JOIN 
            local_agent_details 
        ON 
            fagent_company_details.fagentID = local_agent_details.localagentId WHERE fagent_company_details.softdeletestatus = 1 AND local_agent_details.regStatus = 'pending'
    ";
