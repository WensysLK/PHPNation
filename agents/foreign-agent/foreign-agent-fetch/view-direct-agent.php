<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    <?php
        ...
        ON 
            fagent_company_details.fagnetCompanyID = foreign_agent_details.fagentId WHERE fagent_company_details.softdeletestatus = 1 AND foreign_agent_details.fagentType = 'direct'
    ";
    ...
    <?php } else {
                echo "<div class='alert alert-primary mt-2' role='alert'> No Direct Agents!</div>";
            }
        } ?>
</table>
