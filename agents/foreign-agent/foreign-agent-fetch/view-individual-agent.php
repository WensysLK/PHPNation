...
<table id="viewindividual" class="table table-striped table-bordered mt-2" style="width:100%">
    <?php
        $sqlapplication = "
        SELECT `fagentId`,`fagentType`, `fagentProfile`, `fagentTitle`, `fagentFname`, `fagentMname`, `fagentLname`, `fagentIqamaNo`, `fagentWhatzapp`, `fagentEmail`, `fagentRemark`, `fagentMap` FROM `foreign_agent_details` WHERE `softdeletestatus`=1 AND `fagentType`='Individual'
    ";
