...
<table id="viewcompanyagent" class="table table-striped table-bordered mt-2" style="width:100%">
    <?php
        ...
        ON 
            fagent_company_details.fagnetCompanyID = foreign_agent_details.fagentId WHERE fagent_company_details.softdeletestatus = 1 AND foreign_agent_details.fagentType = 'company'
    ";
    ...
    <thead>
        <tr>
            ...
            <th>Company Name</th>
            <th>BR No</th>
            <th style="width:auto;">Agency License</th>
            <th>Contacts</th>
            <th>Actions</th>
        </tr>
    </thead>
