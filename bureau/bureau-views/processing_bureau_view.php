<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlmedical = "SELECT 
    bureau_details.bureauId,
    bureau_details.contractId, 
...
FROM 
    bureau_details
JOIN 
    applications ON bureau_details.clientId = applications.applicationID
JOIN 
    enjaz_details ON bureau_details.enjazId = enjaz_details.EnjazId
JOIN 
...
WHERE 
    bureau_details.bureaustatus='processing' AND bureau_details.softdeletestatus = 1  ";
