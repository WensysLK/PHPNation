            ...
            <table class="table table-bordered" id="personalInfoTable">
                ...
                <tr style="background-color: #f2f2f2;">
                    <td colspan="6" style="text-align: right;">
                        ...
                        <a href="#personalinfo" data-bs-toggle="modal"
                            class="btn btn-warning btn-sm">Edit Personal Information</a>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-danger btn-sm"
                                onclick="return confirm('Are you sure you want to delete this license?');">Delete</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
