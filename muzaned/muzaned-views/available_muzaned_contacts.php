<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlmedical = "SELECT contract_details.contractId, contract_details.ContractStartus, 
                   ...
                   WHERE contract_details.ContractStartus = 'started' AND contract_details.hasMuzaned=1
                     AND contract_details.softdeletestatus = 1 AND contract_details.MuzanedStatus='not_started'";
