<table id="viewclints" class="table table-striped table-bordered mt-2" style="width:100%">
    ...
    $sqlmedical = "SELECT muzaned_details.muzanedId,muzaned_details.*, 
...
ON muzaned_details.clientId = contract_details.applicationID WHERE muzaned_details.muzanedStatus='completed' AND muzaned_details.softdeletestatus=1";
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="#updatemuzaned" class="btn btn-primary btn-sm lni " data-bs-toggle="modal" data-muzaned-id="<?php echo $muzanedId; ?>" data-client-id="<?php echo $applicantID; ?>"
    ...
    <?php 
            ...
            echo "<div class='alert alert-primary mt-2' role='alert'> No completed  Muzaned!</div>";
        }
    } ?>
</table>